      ...
      <div className="h-16 m-auto flex justify-between items-center w-11/12">
        <nav className="h-full">
          <ul className="list-none h-full flex items-center pl-0">
            <li
              className={`float-left text-sm font-bold h-full flex items-center relative w-max mx-2 ${styles.headerNavLi}`}
            >
              <Link to="/">
        ...
        {!storedUserDataString ? (
          <div className="flex">
            ...
            <div className="text-white py-2 px-3 rounded-lg bg-111111 hover:bg-404040 transition-color duration-500">
              <Link to="/register">
                <p>Đăng ký</p>
              </Link>
            </div>
