        ...
        <div className={`calc-64 bg-F5F7FA flex flex-col justify-center items-center bg-image`}>
            ...
            <div className={`h-max rounded-md py-4 px-4 border-b-2 border-4CAF4F bg-white`}>
                <div className={`flex justify-around items-center`}>
                    <div
                        className=" flex items-center justify-around py-1 px-5 border-2 border-yellow-200 rounded-2xl h-24">
                    ...
                    <div
                        className=" flex items-center justify-between py-1 px-7 border-2 border-yellow-200 rounded-2xl h-24">
